    ...
    <div class="content-wrapper">
        <div class="page-content">
            <div class="container-fluid">
                <div class="col-lg-8">
                    <form action="/obat/{{ $medicine->id }}" method="post" class="mb-5" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="fromGroup mb-3">
                            ...
                            @enderror"
                                id="code" name="code" required autofocus value="{{ old('code', $medicine->code) }}"
                                autocomplete="off">
                            @error('code')
                        ...
                        <div class="fromGroup mb-3">
                            ...
                            @enderror"
                                id="name" name="name" required autofocus value="{{ old('name', $medicine->name) }}"
                                autocomplete="off">
                            @error('name')
                                <div id="validationServer04Feedback" class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="fromGroup mb-3">
                            ...
                            @enderror"
                                id="stock" name="stock" required autofocus
                                value="{{ old('stock', $medicine->stock) }}" autocomplete="off">
                            @error('stock')
                                <div id="validationServer04Feedback" class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
