    ...
    <div class="content-wrapper">
        <div class="page-content">
            <div class="container-fluid">
                <div class="col-lg-8">
                    <div style="font-size: 24px;font-weight:700;text-align:center;margin-bottom:50px;">Formulir Tindakan
                        Operasi</div>
                    <form action="/persuratan/buat/tindakanoperasi" method="post" class="mb-5" enctype="multipart/form-data">
                        @csrf
