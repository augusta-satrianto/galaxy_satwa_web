...
<body>
    <div class="paper">
        ...
        <div class="identitas-pasien">
            <div style="text-align: center;margin-bottom:10px;"><strong>SURAT BERITA KEMATIAN PASIEN</strong></div>
            ...
            <p style="margin-left:17px;">Telah mengalami kematian pada</p>
            <table style="width: 100%;margin-left:17px; padding: 0;" cellspacing="0" cellpadding="0">
                <tr>
                    <td style="margin: 0; padding: 0;width: 280px;">
                        <p>Tanggal</p>
                    ...
                    <td style="margin: 0; padding: 0;">
                        <p>:&nbsp;&nbsp;{{ $data['tanggalkematian'] }}</p>
                        <p>:&nbsp;&nbsp;{{ $data['pukulkematian'] }}</p>
                        <p>:&nbsp;&nbsp;{{ $data['tempatkematian'] }}</p>
                    </td>
                </tr>
            </table>
            <table style="width: 100%;margin-left:17px; padding: 0;" cellspacing="0" cellpadding="0">
                <td style="margin: 0; padding: 0;width: 280px;">
                    <p>Dengan sebab kematian</p>
                </td>
                <td style="margin: 0; padding: 0;width: 10px;">
                    <p>:&nbsp;&nbsp;</p>
                </td>
                <td style="margin: 0; padding: 0;">
                    <p>{{ $data['sebabkematian'] }}</p>
                </td>
            </table>
        </div>
