    ...
    <div class="content-wrapper">
        <div class="page-content">
            <div class="container-fluid">
                <div class="col-lg-8">
                    <div style="font-size: 24px;font-weight:700;text-align:center;margin-bottom:50px;">Formulir Berita
                        Kematian</div>
                    <form action="/persuratan/buat/beritakematian" method="post" class="mb-5" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div style="font-size: 20px;font-weight:700;">Data Kematian</div><br>
                        <div class="fromGroup has-icon mb-3">
                            <label>Tanggal</label>
                            <div class="form-control-icon">
                                <input id="tanggalmasuk" name="tanggalkematian" class="form-control date-picker-calender"
                                    type="text" placeholder="DD / MM / YY" autocomplete="off" required />
                                <div class="icon-badge-2">
                                    <img src="../../images/svg/calendar.svg" alt="" />
                                </div>
                        ...
                        <div class="fromGroup mb-3">
                            <label>Pukul</label>
                            <input type="text" placeholder="Masukkan pukul kematian"
                                class="form-control @error('pukulkematian') is-invalid               
                            @enderror"
                                id="pukulkematian" name="pukulkematian" autofocus value="{{ old('pukulkematian') }}"
                                autocomplete="off">
                            @error('pukulkematian')
                                <div id="validationServer04Feedback" class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="fromGroup mb-3">
                            <label>Tempat</label>
                            <input type="text" placeholder="Masukkan tempat kematian"
                                class="form-control @error('tempatkematian') is-invalid               
                            @enderror"
                                id="tempatkematian" name="tempatkematian" autofocus value="{{ old('tempatkematian') }}"
                                autocomplete="off">
                        ...
                        <div class="fromGroup mb-3">
                            <label>Sebab</label>
                            <input type="text" placeholder="Masukkan sebab kematian"
                                class="form-control @error('sebabkematian') is-invalid               
                            @enderror"
                                id="sebabkematian" name="sebabkematian" autofocus value="{{ old('sebabkematian') }}"
                                autocomplete="off">
                            @error('sebabkematian')
                                <div id="validationServer04Feedback" class="invalid-feedback">{{ $message }}</div>
                            @enderror
