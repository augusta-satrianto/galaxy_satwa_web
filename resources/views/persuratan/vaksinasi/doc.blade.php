...
<body>
    <div class="paper">
        ...
        <div class="identitas-pasien">
            <div style="text-align: center;margin-bottom:10px;"><strong>SURAT PERNYATAAN KESEDIAAN PEMBERIAN INJEKSI
                    DAN/ATAU VAKSINASI
                </strong></div>
        ...
        <div class="approval" style="font-size:11pt;text-align:justify;">
            <p>Dengan ini saya Pemilik Hewan memberikan persetujuan dan wewenang kepada dokter untuk
                melakukan tindakan pemberian (injeksi dan/atau vaksinasi) yang dipilihnya menurut prosedur
                yang telah dijelaskan kepada saya dan telah saya mengerti. </p>
            <ol type="a">
                <li style="text-align:justify;">Menyerahkan pasien sepenuhnya kepada pihak keluarga sesuai dengan arahan
                    dan penjelasan dari dokter.</li>
                <li style="text-align:justify;">Telah memahami hak dan kewajiban pasien.</li>
            ...
            <strong>
                <ol>
                    <li style="text-align:justify;">Saya mengerti dan menerima semua resiko tindakan medis yang akan
                        dilakukan dan memberikan kewenangan penuh pada dokter hewan untuk melakukan
                    ...
                    <li style="text-align:justify;">Saya tidak akan menuntut secara hukum baik pidana maupun perdata
                        ...
                        dengan prosedur standar seorang Dokter Hewan profesional.</li>
                </ol>
            </strong>
