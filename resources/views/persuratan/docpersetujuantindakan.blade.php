...
<body>
    <div class="paper">
            ...
            <tr>
                <td style="width: 2.76cm; text-align: center;">
                    <img style="width: 2.76cm;height:2.76cm;"
                        src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('images/logo/logo-klinik.jpg'))) }}">
                </td>
                <td>
        ...
        <div class="identitas-pasien">
            <div style="text-align: center;"><strong>SURAT PERSETUJUAN DILAKUKAN TINDAKAN
                    PASIEN</strong></div>
        ...
        <div class="approval" style="font-size:11pt;text-align:justify;">
            ...
            <p style="margin-left:17px;"> a. Pemeriksaan secara medis kesehatan hewan secara langsung<br>
                b. Pemasangan infus / pengambilan specimen untuk dilakukan diagnosa laboratoris<br>
                c. Injeksi obat – obatan yang dibutuhkan pasien sesuai dengan hasil pemeriksaan<br>
                d. Penjahitan luka / perawatan luka<br>
                e. Operasi : .....................................<br>
                f. Dll : .....................................</p>
            ...
            <strong>
                <ol>
                    <li style="text-align:justify;">Saya mengerti dan menerima semua resiko tindakan medis yang akan
                        ...
                        memberikan
                        kewenangan
                        penuh pada dokter hewan untuk melakukan tindakan tersebut sesuai prosedur kedokteran
                        hewan.</li>
                    <li style="text-align:justify;">Saya tidak akan menuntut secara hukum baik pidana maupun perdata
                        dalam bentuk apapun atas resiko
                        yang
                        ditimbulkan atas tindakan medis yang telah diambil sesuai dengan prosedur standar seorang Dokter
                        Hewan
                        profesional.</li>
                </ol>
            </strong>
        ...
        <!-- Tanda tangan -->
        <p style="text-align:
                right;font-size:11pt;padding:0;margin:0;">Gresik, ………. /……… / 20….</p>
        <table style="width: 100%;margin-left:40px;;padding:0;font-size:11pt;">
            <tr>
                <td>
                    <div>
