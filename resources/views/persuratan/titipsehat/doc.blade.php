...
<body>
    <div class="paper">
        ...
        <div class="identitas-pasien">
            <div style="text-align: center;margin-bottom:10px;"><strong>SURAT PERSETUJUAN RAWAT JALAN PASIEN
                    UMUM</strong></div>
        ...
        <p style="padding: 0;margin:0;"><strong>3. INFORMASI YANG DIBERIKAN </strong></p>
        <div style="padding: 0;margin:0;" class="approval" style="font-size:11pt;text-align:justify;">
            <ol type="a" style="margin-top:0;">
                <li style="text-align:justify;">Menyerahkan pasien sepenuhnya kepada pihak keluarga sesuai dengan arahan
                    dan
                    penjelasan dari dokter. </li>
                <li style="text-align:justify;">Telah memahami hak dan kewajiban pasien saat penitipan
                </li>
                <li style="text-align:justify;">Bersedia membayar seluruh biaya perawatan dan penitipan pasien secara
                    tunai atau transfer.
                </li>
                <li style="text-align:justify;">Keterangan khusus terkait kebutuhan pasien
                    :<br>{{ $data['keterangankhusus'] }}</li>
            </ol>

            <p style="margin: 0;">Dengan ini saya Pemilik Hewan diatas telah mengerti dan menyadari sepenuhnya atas
                penjelasan dokter hewan dan menyatakan ; </p>
            <strong>
                <ol>
                    <li style="text-align:justify;">Saya mengerti dan menerima semua resiko yang dapat terjadi selama
                        penitipan dan
                        memberikan kewenangan penuh pada dokter hewan untuk melakukan tindakan
                        medis apabila diperlukan dengan dan/ atau tanpa sepengetahuan pemilik sesuai
