...
<body>
    <div class="paper">
        ...
        <div class="identitas-pasien">
            <div style="text-align: center;margin-bottom:10px;"><strong>SURAT PERSETUJUAN RAWAT INAP PASIEN
                    UMUM</strong></div>
        ...
        <div class="approval" style="font-size:11pt;text-align:justify;">
            <ol type="a">
                <li style="text-align:justify;"> Menyerahkan perawatan pasien sepenuhnya kepada pihak
                    “Klinik Hewan Galaxy Satwa”</li>
                <li style="text-align:justify;">Menaati tata tertib di “Klinik Hewan Galaxy Satwa”.</li>
                <li style="text-align:justify;"> Telah memahami hak dan kewajiban pasien saat opname di “Klinik Hewan
                    Galaxy Satwa”.</li>
                <li style="text-align:justify;">Memahami tarif yang ada di “Klinik Hewan Galaxy Satwa”.</li>
                <li style="text-align:justify;">Bersedia membayar seluruh biaya pengobatan, perawatan dan tindakan medis
                    pasien secara
                    tunai atau transfer.</li>
            </ol>
            <br>
            <p style="margin: 0;">Dengan ini saya Pemilik Hewan diatas telah mengerti dan menyadari sepenuhnya atas
                penjelasan
                dokter hewan dan menyatakan ; </p>
            <strong>
                <ol>
                    <li style="text-align:justify;">Saya mengerti dan menerima semua resiko yang dapat terjadi selama
                        ...
                        tindakan medis apabila diperlukan dengan dan/ atau tanpa sepengetahuan pemilik
                        sesuai prosedur kedokteran hewan.
                    </li>
