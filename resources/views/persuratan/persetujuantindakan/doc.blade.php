...
<body>
    <div class="paper">
        ...
        <div class="identitas-pasien">
            <div style="text-align: center;margin-bottom:10px;"><strong>SURAT PERSETUJUAN DILAKUKAN TINDAKAN
                    PASIEN</strong></div>
        ...
        <div class="approval" style="font-size:11pt;text-align:justify;">
            <p>Setelah dilakukan penjelasan oleh dokter / petugas, saya menyatakan bersedia menyetujui tindakan
                tindakan yang dilakukan yaitu :</p>
            <ol type="a">
                <li style="text-align:justify;">Pemeriksaan secara medis kesehatan hewan secara langsung</li>
                <li style="text-align:justify;">Pemasangan infus / pengambilan specimen untuk dilakukan diagnosa
                    laboratoris</li>
                <li style="text-align:justify;">Bersedia membayar seluruh biaya pasien secara tunai atau transfer.</li>
                <li style="text-align:justify;">Injeksi obat – obatan yang dibutuhkan pasien sesuai dengan hasil
                    pemeriksaan</li>
                <li style="text-align:justify;">Penjahitan luka / perawatan luka</li>
                <li style="text-align:justify;">Operasi : {{ $data['operasi'] }}</li>
                <li style="text-align:justify;">Dll : {{ $data['lain'] }}</li>
            </ol>
            <p style="margin: 0;">Menyatakan Bahwa :</p>
            <strong>
                <ol>
                    <li style="text-align:justify;">Saya mengerti dan menerima semua resiko tindakan medis yang akan
                        dilakukan dan memberikan kewenangan penuh pada dokter hewan untuk melakukan tindakan tersebut
                        sesuai prosedur kedokteran
                        hewan.</li>
                    <li style="text-align:justify;">Saya tidak akan menuntut secara hukum baik pidana maupun perdata
                        dalam bentuk apapun atas resiko yang ditimbulkan atas tindakan medis yang telah diambil sesuai
                        dengan prosedur standar seorang Dokter
                        Hewan profesional.</li>
                </ol>
            </strong>
