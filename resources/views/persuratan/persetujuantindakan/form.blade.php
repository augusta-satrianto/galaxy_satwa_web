    ...
    <div class="content-wrapper">
        <div class="page-content">
            <div class="container-fluid">
                <div class="col-lg-8">
                    <div style="font-size: 24px;font-weight:700;text-align:center;margin-bottom:50px;">Formulir Persetujan
                        Tindakan</div>
                    <form action="/persuratan/buat/persetujuantindakan" method="post" class="mb-5"
                        ...
                        <div style="font-size: 20px;font-weight:700;">Tindakan-tindakan</div><br>
                        <div class="fromGroup mb-3">
                            <label>Operasi</label>
                            <input type="text" placeholder="Masukkan tindakan operasi"
                                class="form-control @error('operasi') is-invalid               
                            @enderror"
                                id="operasi" name="operasi" required autofocus value="{{ old('operasi') }}"
                                autocomplete="off">
                            @error('operasi')
                                <div id="validationServer04Feedback" class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="fromGroup mb-3">
                            <label>Dan lain-lain (optional)</label>
                            <input type="text" placeholder="Masukkan tindakan lainnya (optional)"
                                class="form-control @error('lain') is-invalid               
                            @enderror"
                                id="lain" name="lain" autofocus value="{{ old('lain') }}" autocomplete="off">
                            @error('lain')
                                <div id="validationServer04Feedback" class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div><br><br>
