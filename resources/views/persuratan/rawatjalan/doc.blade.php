    ...
    <div class="paper">
        ...
        <div style="padding: 0;margin:0;" class="approval" style="font-size:11pt;text-align:justify;">
            <ol type="a" style="margin-top:0;">
                ...
                <li style="text-align:justify;">Telah memahami hak dan kewajiban pasien saat rawat jalan.
                </li>
                ...
                <li style="text-align:justify;">Owner / keluarga pasien bersedia menginformasikan perkembagan kondisi
                    pasien secara
                    berkala kepada pihak klinik hewan galaxy satwa.</li>
                <li style="text-align:justify;">Status pasien saat pulang untuk rawat jalan
                    :<br>{{ $data['statuspasien'] }}</li>
            </ol>
