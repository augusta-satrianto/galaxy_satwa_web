    ...
    <div class="content-wrapper">
        <div class="page-content">
            <div class="container-fluid">
                <div class="col-lg-8">
                    <div style="font-size: 24px;font-weight:700;text-align:center;margin-bottom:50px;">Formulir Rawat Jalan
                    </div>
                    <form action="/persuratan/buat/rawatjalan" method="post" class="mb-5" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="fromGroup mb-3">
                            <label>Status pasien saat pulang untuk rawat jalan</label>
                            <input type="text" placeholder="Masukkan status pasien"
                                class="form-control @error('statuspasien') is-invalid               
                            @enderror"
                                id="statuspasien" name="statuspasien" required autofocus
                                value="{{ old('statuspasien') }}" autocomplete="off">
                            @error('statuspasien')
                                <div id="validationServer04Feedback" class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
